...
def page(browser):
    ...
    pg.evaluate("""() => {
        ...
        s.set("time_step_duration", "");
        s.set("time_step_resolution", "");
        ...
        s.set("project_dirty", false);
        s.set("project_filename", "");
        s.set("project_zip_payload", null);
        s.set("project_upload_payload", null);
        s.set("open_project_trigger", 0);
